...
/**
 * Metadata carried in {@link com.chung.ai.software.openclaw4j.gateway.eventqueue.GatewayEvent#getMetadata()}
 * for WEBHOOK events.
 *
 * Bundles the resolved definition together with the raw incoming payload so
 * that {@link com.chung.ai.software.openclaw4j.gateway.dispatcher.AgentDispatcher}
